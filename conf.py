...
BLOG_AUTHOR = "Josef Affourtit"  # (translatable)
BLOG_TITLE = "Josef Affourtit"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.josefaffourtit.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.josefaffourtit.com/"
BLOG_EMAIL = "jaffourt@mit.edu"
BLOG_DESCRIPTION = "Hello. This is my personal website."  # (translatable)
